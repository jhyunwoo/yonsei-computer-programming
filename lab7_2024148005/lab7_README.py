...
# NOTE: If execution fails, all questions receive zero points.               #
##############################################################################
...
# function gcd(n1, n2) will return an integer type value
# Requirement 1: n1 must be less than or equal to n2
# Requirement 2: n1 and n2 must be integer values (type int)
# * n: type int, number of occurences of gcd function calls in the code
...
# Example 1: gcd(1, 2): [1, 1, 1]
# Example 2: gcd(2, 1): [1, 0, 1]
# Example 3: gcd(1.0, 2): [1, 1, 0]
# If the first 'gcd' function call fails, then you should consider
# the second 'gcd' function call not satisfying any requirements.
# Example 4: gcd(1, gcd(2, 3)): [2, 2, 2]
# Example 5: gcd(1, gcd(1.0, 2)): [2, 1, 0]
#
q2_a_answer = [1, 1, 1]
q2_b_answer = [1, 1, 0]
q2_c_answer = [1, 0, 1]
